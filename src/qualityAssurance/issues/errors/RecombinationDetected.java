...
public class RecombinationDetected extends QualityWarning {
...
//	}
	public RecombinationDetected(QualityAssistent assistent, TestSample sampleOfIssue,Haplogroup remainingHaplogroup,double remainingQuality) {
		super(assistent, sampleOfIssue, "Possible recombiantion detected");
